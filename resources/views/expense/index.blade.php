        ...
        <div class="flex items-center -mr-2">
            <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative mytable">
                ...
                <tbody>
                    ...
                    <tr class="sticky top-0 border-b border-gray-300 items-center text-xs hover:bg-green-100">
                        <td class="py-4 px-2 pl-3"><input type="checkbox" name="" id=""></td>
                        <td class="w-12 text-left pr-2">{{ \Carbon\Carbon::parse($expense->expense_date)->format('d M') }} </td>
